...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="{{ route('admin.kadi.shops') }}"><i class="fas fa-store"></i> Manajemen Warung</a>
            <a href="{{ route('admin.kadi.transactions') }}" class="active"><i class="fas fa-receipt"></i> Semua
                Transaksi</a>
