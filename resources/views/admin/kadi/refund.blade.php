                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif($refund->status === 'APPROVED')
                                            <span class="badge badge-approved px-3 py-2 rounded-pill">✅
                                                Disetujui</span>
                                        @else
                                    ...
                                    <td class="text-center pe-4">
                                        @if ($refund->status === 'PENDING')
                                            <div class="d-flex gap-2 justify-content-center">
                                                {{-- Approve --}}
                                                <form action="{{ route('admin.kadi.refund.approve', $refund->id) }}"
                                                    method="POST"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content border-0 shadow rounded-4">
                                                        <div class="modal-header border-0">
                                                            <h6 class="modal-title fw-bold">Tolak Permintaan Refund
                                                            </h6>
                                                            <button type="button" class="btn-close"
                                                                data-bs-dismiss="modal"></button>
                                                        </div>
                                                        <form
                                                            action="{{ route('admin.kadi.refund.reject', $refund->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            <div class="modal-body pt-0">
                                                                <p class="text-muted small mb-3">
                                                                    ...
                                                                    akan dikembalikan ke akun
                                                                    <strong>{{ $refund->user->name }}</strong>.
                                                                </p>
                                                                <label class="form-label small fw-semibold">Alasan
                                                            ...
                                                            <div class="modal-footer border-0 pt-0">
                                                                ...
                                                                <button type="submit"
                                                                    class="btn btn-danger btn-sm rounded-pill px-4">Tolak
                                                                    & Kembalikan Saldo</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                        ...
                                        @elseif($refund->status === 'APPROVED')
                                            <small
                                                class="text-muted">{{ $refund->approved_at?->format('d M H:i') }}</small>
                                        @else
