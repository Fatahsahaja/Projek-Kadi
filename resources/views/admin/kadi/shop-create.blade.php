...
<head>
    ...
    <style>
        ...
        .section-divider {
            border: none; border-top: 2px dashed #f0f0f0;
            margin: 25px 0;
        }
        .section-title {
            font-weight: 600; color: #f7941d;
            ...
            <form action="{{ route('admin.kadi.shops.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="shop_name" class="form-control"
                           placeholder="contoh: Kantin Bu Sari" value="{{ old('shop_name') }}" required>
                </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="admin_phone" class="form-control"
                               placeholder="08xxxxxxxxxx" value="{{ old('admin_phone') }}">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Email <span class="text-danger">*</span></label>
                        <input type="email" name="admin_email" class="form-control"
                               placeholder="admin@kantin.com" value="{{ old('admin_email') }}" required>
                    </div>
                    <div class="col-md-6">
